...
theme.icon_dir                                  = os.getenv("HOME") .. "/.config/awesome/themes/lolo/icons"
theme.wallpaper                                 = os.getenv("HOME") .. "/.config/awesome/themes/lolo/wall.png"
...
awful.util.tagnames   = { "work", "perso", "zik" }
...
spotify_widget:set_font(theme.font)
awful.widget.watch(
...
local spotifywidget = wibox.container.margin(spotify_widget, 0, 0, 5, 5)
